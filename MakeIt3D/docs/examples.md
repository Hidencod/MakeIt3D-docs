...
<ExamplesGrid examples={[
  {
    id: "rotating-cube",
    title: "Rotating Cube",
    description: "A simple spinning cube demonstrating basic 3D object creation, materials, and animation in MakeIt3D.",
    thumbnail: "/img/examples/rotating-cube.jpg",
    difficulty: "Beginner",
    tags: ["3D Objects", "Animation", "Materials"],
    playUrl: "https://example.com/play/rotating-cube",
  ...
  },
  {
    ...
    thumbnail: "/img/examples/lighting-demo.jpg",
