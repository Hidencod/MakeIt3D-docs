...
Let's say you have a placeholder object named "Enemy" with UID `5`:

```javascript
// Create different enemy instances
CreateObject("Enemy", 0)  // Creates: Enemy_5_0
CreateObject("Enemy", 1)  // Creates: Enemy_5_1  
CreateObject("Enemy", 2)  // Creates: Enemy_5_2
```
